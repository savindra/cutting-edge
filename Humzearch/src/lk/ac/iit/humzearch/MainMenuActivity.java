...
public class MainMenuActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//User profile
		navDrawerItems.add(new NavDrawerItem(user.getString("name"),user.getParseFile("image").getUrl(), NavDrawerListAdapter.TYPE_USER));
		// Record tune
		navDrawerItems.add(new NavDrawerItem(navMenuTitles[1], navMenuIcons.getResourceId(0, -1), NavDrawerListAdapter.TYPE_MENU));
        // Find People
        navDrawerItems.add(new NavDrawerItem(navMenuTitles[2], navMenuIcons.getResourceId(1, -1), NavDrawerListAdapter.TYPE_MENU));
        // Photos
